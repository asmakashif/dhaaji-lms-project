                                    ...
                                    <div class="post-list" id="dataList">
                                        <div class="card-deck">
                                            <?php if(!empty($course)){ foreach($course as $row){ 
                                                ...
                                                ?>
                                                <div class="col-md-4">
                                                    <img class="card-img-top" src="<?php echo base_url().'uploads/'. $row['course_img'];?>" style="height:150px;width:250px;">

                                                    <div class="caption">
                                                        <h6><a href="#"><?php echo $row['course_name']; ?></a></h6>
                                                        <div id='rs'><b>Price</b>:<big>
                                                            ₹ <?php echo $price; ?></big>
                                                        </div>
                                                        <?php
                                                        echo form_open('shopping/add');
                                                        echo form_hidden('course_id', $id);
                                                        echo form_hidden('course_name', $name);
