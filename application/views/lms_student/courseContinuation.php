...
<div class="mdk-drawer-layout__content page ">
    <div class="container-fluid page__container">
        <ol class="breadcrumb">
            ...
            <!-- <li class="breadcrumb-item"><a href="<?php echo base_url('student_controller/course/view_course($course_id)');?>">Chapters</a></li> -->
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="alert alert-dismissible bg-success text-white border-0 fade show successmsg" role="alert">
                        ...
                        Start new course/chapter to access this section <a style="color: red;" href="<?php echo base_url('shopping/index');?>">Click here</a>
                    </div>
                    <div id="video" class="embed-responsive embed-responsive-16by9">
                        <video id="videoarea" class="embed-responsive-item" allowfullscreen="" controls controlsList="nodownload" src="" type="video/mp4"></video>
                    ...
                    <ul class="card list-group list-group-fit" onClick="playlist();" id="playlist">
                        <li class="list-group-item" id="<?php echo $row->section_id; ?>" src="<?php echo base_url().'uploads/videos/'. $row->video_path;?>" ><?php echo $count++; ?>&nbsp; &nbsp;<?php echo $row->section_name; ?>
                    ...
                    <!-- Lessons -->
                    <?php $count=1;
                        foreach($cont_course as $row){?>
                    <ul class="card list-group list-group-fit" onClick="playlist();" id="playlist">
                        <li class="list-group-item" id="<?php echo $row->section_id; ?>" src="<?php echo base_url().'uploads/videos/'. $row->video_path.'#t='.$cont_course[0]->timePlayed;?>" ><?php echo $count++; ?>&nbsp; &nbsp;<?php echo $row->section_name; ?>
                            <small class="text-muted-light"><?php echo date('i:s', strtotime($row->video_time))?> </small>
                    </ul>
                    <?php
                        }
