        ...
        <div class="col-sm-8 col-md-6 col-lg-4 mx-auto" style="min-width: 300px;">
            ...
            <div id="content-desktop">
                <div class="card navbar-shadow">
                    ...
                    <div class="card-body">
                        <?php echo form_open('user_controller/auth');?>
                        ...
                        <div style="text-align:center;">
                            ...
                            <div style="display: inline;"><a href="<?php echo site_url('user_controller/forgotPassword');?>" class="NrmLnk">Forgot Password?</a></div>
                        </div>
                        <?php echo form_close();?>
                    </div>
                    <div class="card-footer text-center text-black-50">
                        Not yet a student? <a href="<?php echo base_url('user_controller/register');?>">Sign Up</a>
                    </div>
                </div>
            </div>
