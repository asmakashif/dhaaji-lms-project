        ...
        <div class="col-sm-8 col-md-6 col-lg-4 mx-auto" style="min-width: 300px;">
            ...
            <div id="content-desktop">
                <div class="card navbar-shadow">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('user_controller/resetlink');?>" method="post">
                            <div class="form-group">
                                <label class="form-label" for="email">Email</label>
                                <div class="input-group input-group-merge">
                                    <input name="email" type="email" required="" class="form-control form-control-prepended" placeholder="Your email address">
                            ...
                            <div class="form-group ">
                                <input name="submit" type="submit" class="btn btn-success" value="Reset password">
                            </div>
