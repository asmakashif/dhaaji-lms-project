...
<body class="login">
    ...
    <div class="d-flex align-items-center" >
        <div class="col-sm-10 col-md-8 col-lg-6 mx-auto" style="min-width:400px;">
            ...
            $card_holder_name = $data_info->name;
                            ...
                            <div class="list-group-item">
                                <fieldset role="group" aria-labelledby="label-type" class="m-0 form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input name="subject" readonly="" type="text" value="<?php echo $data_info->book_name; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input name="fees" readonly="" type="text" value="<?php echo $data_info->book_price; ?>" class="form-control">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
