        ...
        <div class="mdk-drawer-layout__content page ">
            ...
            <div class="container-fluid page__container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Deactivate Student</li>
                </ol>
                <h1 class="h2">Deactivate Student</h1>
                <div class="card">
                    ...
                    <div class="card-body">
                     <div class="row">
                        ...
                        <div class="col-lg-10">
                            <form id="deactivate" method="post" action="<?php echo base_url('admin_controller/student_management/in_activeMail/'.$fetchdatabyid[0]->id);?>">
                                <div class="form-row">
                                ...
                                <button type="submit" class="btn btn-success" style="background-color:yellowgreen;border-color:yellowgreen">Deactivate</button>
                            </form>
                        </div>
                    </div>
                    </div>
