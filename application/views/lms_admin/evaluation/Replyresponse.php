        ...
        <div class="mdk-drawer-layout__content page ">
            ...
            <div class="container-fluid page__container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url('admin_controller/ResponseController/students_response');?>">Student Response</a></li>
                    <li class="breadcrumb-item active">Reply</li>
                </ol>

                <h1 class="h2">Reply</h1>
                <form action="<?php echo base_url('admin_controller/ResponseController/saveCommentReply');?>" method="post">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group m-0" role="group" aria-labelledby="label-question">
                                <div class="form-row align-items-center">
                                    ...
                                    <div class="col-md-9">
                                        <input name="username" id="email" type="text" placeholder="Enter Name" readonly="" value="<?php echo $userData['firstname']?>" class="form-control">
                            ...
                            <div id='submit' class="list-group-item">
                                ...
                                <button type="cancel" value="cancel" class="btn btn-warning"><a href="<?php echo base_url('admin_controller/ResponseController/students_response');?>" style="text-decoration:none;color:white;">Cancel</a></button>
                            </div>
                        </div>
                    </div>
                </form>
