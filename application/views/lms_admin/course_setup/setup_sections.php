...
<div class="mdk-header-layout__content">
    ...
    <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="btn-group">
                                    <form action="<?php echo base_url('admin_controller/master/getListBoardClassSubjectChaptersSections');?>" method="post">
                                    ...
                                    <div class="btn-group">
                                        <select required="" name="subject" id="subject_id_select" class="form-control" required data-md-selectsize>
                                            <option value="">Subject</option>
                                        </select>
                                    </div>

                                    <div class="btn-group">
                                        <select required="" name="chapter" onchange="this.form.submit()" onchange="this.form.submit()" id="chapter_id_select" class="form-control" required data-md-selectsize>
                                            ...
                                            if(!empty($sections)){
                                                foreach ($sections as $key => $subj) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="js-lists-values-employee-name"><?php echo $subj->section_name ?></span>
                                                        </td>
                                                        <td>
                                                            <span class="js-lists-values-employee-name"><?php echo $subj->video_path;?>
                                                        </td>
                                                        <td> 
                                                            <div class="form-group">
                                                                <div class="custom-controls-stacked">
                                                                    <div class="custom-control custom-radio">
                                                                        <input value="<?php echo $subj->section_name;?>" name="section_name" id="<?php echo $subj->section_id?>" type="radio" class="custom-control-input">
                                                                        <label for="<?php echo $subj->section_id?>" class="custom-control-label"></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                ...
                                <br>
                                <button type="button" class="btn btn-primary" onclick="windows:location.href='https://trailroom.in/dhaji_lms/admin_controller/admin_dashboard/setup_chapters'">Prev</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        if(modalBox == 'popup1'){
            if($("input:radio[name='section_name']").is(":checked")){
                var subject_name = $("input[name='section_name']:checked").val();
                var s_id = $('input[type=radio][name=section_name]:checked').attr('id');
                $('#Sections_1').val(subject_name);
                $('#s_id').val(s_id);
                $(".hideShow").show();
                $(".Errors").hide();
            }else{
            ...
            $.post('<?php echo base_url("admin_controller/master/getClassBoardSubjectChapter")?>',{s_id:s_id},function(data){
                ...
                $('#chapter_id_1').append('<option value="'+obj.chapters_id+'" selected="selected">'+obj.chapters_name+'</option>');
            });
        ...
        if(modalBox == 'popup3'){
            if($("input:radio[name='section_name']").is(":checked")){
                var subject_id = $('input[type=radio][name=section_name]:checked').attr('id');
        ...
        <div id="popup2" class="modal-box modal-box2">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url('admin_controller/master/sectionsAdd');?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <select required="" name="chapter_id" id="chapter_id" required="" class="form-control">

                        </select>
                    </div>

                    <div class="form-group">
                        <input required="" name="sections" type="text" class="form-control"  placeholder="Enter Section Name" id="sections">
                    </div>
                    <div class="form-group">
                        <lable>Upload Video</lable>
                        <input required="" name="video_path" type="file" class="form-control" accept=".mp4,.webm">
                    </div>
            ...
            <div id="popup1" class="modal-box modal-box1">
                ...
                <div class="modal-body hideShow" style="display: none">
                    <form action="<?php echo site_url('admin_controller/master/updateCSections');?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <select required="" name="chapter_id" id="chapter_id_1" required="" class="form-control">

                            </select>
                        </div>

                        <div class="form-group">
                            <input required="" name="sections" type="text" class="form-control"  placeholder="Enter Section" id="Sections_1">
                            <input type="hidden" name="s_id" id="s_id">
                        </div>

                        <div class="form-group">
                            <lable>Upload Video</lable>
                            <input type="file" name="file" class="form-control" accept=".mp4,.webm" id="Sections"/>
                        </div>
                    ...
                    <div class="Errors" style="display: none">
                        <center>
                            <h3>
                                <font color="red">Please select the Section first then update .</font>
                            </h3>
                        </center>
                ...
                <div id="popup3" class="modal-box modal-box3">
                    ...
                    <div class="modal-body hideShow" style="display: none">
                        <form action="<?php echo base_url('admin_controller/master/deleteSections');?>" method="post">
                            <div class="form-group">
                                <center> <h3>Are you soure you want to delete Subject.?<h3></center>
                            ...
                            <div class="Errors" style="display: none">
                                <center>
                                    <h3>
                                        <font color="red">Please select the Section.</font>
                                    </h3>
                                </center>
                            </div>
                            <footer> 
                            ...
                            <script type="text/javascript">
                                ...
                                $("#subject_id").change(function(){
                                    ...
                                    $.post('<?php echo  base_url('admin_controller/master/getListSubjectByIdChapter');?>',{courseid:courseid},function(data){
                                        console.log(data);
                                        var chapterObj=$.parseJSON(data);
                                        var output='';
                                        output+='<option value="">Select Chapter</option>';
                                        var len=chapterObj.length;
                                        for (var i=0,j=len; i < j; i++) {
                                            output+='<option value="'+chapterObj[i].chapters_id+'">'+chapterObj[i].chapters_name+'</option>';
                                        };
                                        $('#chapter_id').html(output);
                                    });
                                });
                                ...
                                $("#subject_id_select").change(function(){
                                    ...
                                    $.post('<?php echo  base_url('admin_controller/master/getListSubjectByIdChapter');?>',{courseid:courseid},function(data){
                                        ...
                                        var chapterObj=$.parseJSON(data);
                                        var output='';
                                        output+='<option value="">Chapter</option>';
                                        var len=chapterObj.length;
                                        for (var i=0,j=len; i < j; i++) {
                                            output+='<option value="'+chapterObj[i].chapters_id+'">'+chapterObj[i].chapters_name+'</option>';
                                        };
                                        $('#chapter_id_select').html(output);
                                    });
                                });
