    ...
    <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
        ...
        <div id="popup2" class="modal-box modal-box2">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin_controller/master/chaptersAdd');?>" method="post">
                    ...
                    <div class="form-group">
                        <input required="" name="chapters" type="text" class="form-control"  placeholder="Enter Subject Chapters" id="Chapters">
                    </div>
            ...
            <div id="popup1" class="modal-box modal-box1">
                ...
                <div class="modal-body hideShow" style="display: none">
                    <form action="<?php echo base_url('admin_controller/master/updateSChapters');?>" method="post">
                        <div class="form-group">
