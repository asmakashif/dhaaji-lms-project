                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <a href="<?php echo base_url('admin_controller/admin_dashboard/upload_chapters');?>"><button type="button" class="btn btn-success">Next</button></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    $('.modal-box3').hide();
        ...
        <div id="popup2" class="modal-box modal-box2">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin_controller/master/subjectAdd');?>" method="post">
            ...
            <div id="popup1" class="modal-box modal-box1">
                ...
                <div class="modal-body hideShow" style="display: none">
                    <form action="<?php echo base_url('admin_controller/master/updateSubject');?>" method="post">
