    ...
    <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
        <div class="mdk-drawer-layout__content page ">
            ...
            <div class="container-fluid page__container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Upload Topper's Video</li>
                </ol>
                <h1 class="h2">Upload Topper's Video</h1>
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody class="list" id="search">
                                            <?php foreach ($video as $key => $vid) { ?>
                                                <tr>
                                                    <td>
                                                        <span class="js-lists-values-employee-name"><?php echo $vid->file_name;?></span>
                                                    </td>

                                                    <td>
                                                        <span class="js-lists-values-employee-name"><?php echo $vid->video_link;?></span>
                                                    </td>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="custom-controls-stacked">
                                                                <div class="custom-control custom-radio">
                                                                    <input value="<?php echo $vid->file_name;?>" name="video_select" id="<?php echo $vid->id?>" name="radio-stacked" type="radio" class="custom-control-input">
                                                                    <label for="<?php echo $vid->id?>" class="custom-control-label"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
        ...
        <script>
            $(function(){
                ...
                $('a[data-modal-id]').click(function(e) {
                    ...
                    if(modalBox == 'popup1'){
                        if($("input:radio[name='video_select']").is(":checked")){
                            var file_name = $("input[name='video_select']:checked").val();
                            var c_id = $('input[type=radio][name=video_select]:checked').attr('id');
                    ...
                    if(modalBox == 'popup3'){
                        if($("input:radio[name='video_select']").is(":checked")){
                            var id = $('input[type=radio][name=video_select]:checked').attr('id');
                            $('#b_id_delete').val(id);
                            $(".hideShow").show();
                            $(".Errors").hide();
                        }else{
        ...
        <div id="popup2" class="modal-box modal-box2">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin_controller/toppers_corner/index');?>" method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input required="" name="video_link" value="https://www.youtube.com/embed/" type="text" class="form-control"  placeholder="Enter Video Link" id="link">
                    </div>
                </div>
                <footer> 
            ...
            <div id="popup1" class="modal-box modal-box1">
                ...
                <div class="modal-body hideShow" style="display: none">
                    <form action="<?php echo base_url('admin_controller/toppers_corner/update');?>" method="post">

                        <div class="form-group">
                            <label for="bname"><b>File Name</b></label></br>
                            <input required="" id="file_name" name="file_name" type="text" class="form-control"  placeholder="Enter File Name">
                            <input type="hidden" name="c_id" id="c_id">
                        </div>

                        <div class="form-group">
                            <label for="bname"><b>Video Link</b></label></br>
                            <input required="" id="video_link" name="video_link" value="https://www.youtube.com/embed/" type="text" class="form-control">
                            <input type="hidden" name="c_id" id="c_id">
                        </div>
                    ...
                    <div class="Errors" style="display: none">
                        <center>
                            <h3>
                                <font color="red">Please select to  update .</font>
                            </h3>
                        </center>
                ...
                <div id="popup3" class="modal-box modal-box3">
                    ...
                    <div class="modal-body hideShow" style="display: none">
                        <form action="<?php echo base_url('admin_controller/toppers_corner/deleteVideo');?>" method="post">
                            <div class="form-group">
