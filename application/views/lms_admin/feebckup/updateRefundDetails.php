        ...
        <div class="mdk-drawer-layout__content page ">
            <div class="container-fluid page__container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url('admin_controller/admin_dashboard/issue_refund');?>">Refund Details</a></li>
                    <li class="breadcrumb-item active">Edit Order Details</li>
                </ol>
                <h1 class="h2">Edit Refund Details</h1>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                            ...
                                            <!-- <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input readonly="" name="txn_id" class="form-control" />
                                                    </div>
                                                </div>
                                            </div> -->
                                            <!-- <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input readonly="" name="plan_name" class="form-control" value="<?php echo $fetchdatabyid->plan_name;?>" />
                                                    </div>
                                                </div>
                                            </div> -->
<!--                                             <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <input readonly=""  name="plan_amount" class="form-control" value="<?php echo $fetchdatabyid->plan_amount;?>" />
                                                    </div>
                                                </div>
                                            </div> -->
                                            <div class="col-lg-6">
