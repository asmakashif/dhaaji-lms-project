    ...
    <div data-push data-responsive-width="992px" class="mdk-drawer-layout js-mdk-drawer-layout">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <br>
                                <button type="button" class="btn btn-primary" onclick="windows:location.href='http://localhost/dhaji/admin_controller/admin_dashboard/setup_chapters'">Previous</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="popup2" class="modal-box modal-box2">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin_controller/master/sectionsAdd');?>" method="post">
            ...
            <div id="popup1" class="modal-box modal-box1">
                ...
                <div class="modal-body hideShow" style="display: none">
                    <form action="<?php echo base_url('admin_controller/master/updateCSections');?>" method="post">
                        <div class="form-group">
