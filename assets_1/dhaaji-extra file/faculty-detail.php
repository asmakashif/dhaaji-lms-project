...
<!-- Mirrored from html.kodesolution.live/h/martialarts/v2.0/demo/page-trainer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Oct 2019 13:28:39 GMT -->
<head>

<!-- Meta Tags -->
<meta name="viewport" content="width=device-width,initial-scale=1.0"/>
<meta http-equiv="content-type" content="text/html; charset=UTF-8"/>
<meta name="description" content="MartialArts- Responsive Template for Karate Academy & Martial Arts Training" />
<meta name="keywords" content="martialarts,karate,training" />
<meta name="author" content="ThemeMascot" />

<!-- Page Title -->
<title>MartialArts- Responsive Template for Karate Academy & Martial Arts Training</title>
...
<div id="wrapper" class="clearfix">
    ...
    <div class="header-top bg-blue-111 sm-text-center p-0">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="widget no-border m-0">
              <ul class="list-inline xs-text-center text-white mt-5">
                ...
                <li class="m-0 pl-10 pr-10"> <a href="#" class="text-white"><i class="fa fa-envelope-o text-theme-colored"></i> contact@yourdomain.com</a> </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-2">
            <a class="btn btn-colored btn-flat btn-theme-colored ajaxload-popup pb-10" href="ajax-load/form-appointment.html">Free Consulting</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <ul class="menuzord-menu">
              ...
              <li><a href="#">Pages</a>
                <ul class="dropdown">
                  ...
                  <li><a href="#">Trainer</a>
                    <ul class="dropdown">
                      <li><a href="page-trainer-style1.html">3 Columns</a></li>
                      <li><a href="page-trainer-style2.html">4 Columns</a></li>
              ...
              <li><a href="#">Classes</a>
                <ul class="dropdown">
                  <li><a href="page-classes-style1.html">Classes Style1</a></li>
                  <li><a href="page-classes-style2.html">Classes Style2</a></li>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg13.jpg">
      <div class="container pt-100 pb-50">
        <!-- Section Content -->
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">Trainer</h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-8">
              <h2 class="name text-theme-colored mt-0 mb-0">Sakib Austin</h5>
          ...
          <div class="row mt-30">
                ...
                <ul>
                  <li class="bg-light media border-bottom p-15 mb-20">
                    ...
                    <div class="media-body">
                      ...
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat voluptates porro eaque labore, delectus quos id harum est!</p>
                    </div>
                  </li>
                  <li class="bg-light media border-bottom p-15 mb-20">
                    <div class="media-left">
            ...
            <div class="col-md-4">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur, nobis doloribus ab repellendus, voluptatum quae quo soluta est.</p>
...
<!-- Mirrored from html.kodesolution.live/h/martialarts/v2.0/demo/page-trainer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Oct 2019 13:28:40 GMT -->
</html>